...
var family={'Married':1983,'presidentOfUnitedStates':false,'Children':['John David','Katia','Olivia','Malcom']};
...
var earlywork = { "Carbon Copy":"1981","A Soldier Story":"1984","Power":"1986","Cry Freedom":"1987","For Queen and Countryy":"1988"};
...
{newdebaters.push(debaters[i].toUpperCase());}
...
//It was my 3th year project, which aim was to facilitate the studies of students leaving abroad. So we made Mobile app and Web app to make this.

// Q18. Describe an ESILV project that you worked on that you’re not so proud of?
//It was my last year project when i was in financial major, i didn't really like the subject so i didn't put all my energy in it. That's why i'm not proud of it and decided to change major to go in IBO.

// Q19. What are some things you like about the developer tools you use?
//I like developer tools i use because it facilitate me to understand my errors and to correct it. It 
...
//Because there's not only one architecture to make a Web application. 